...
Lumora hook function that provides authentication by way of validating the `x-api-key` header.

## Install

```sh
yarn add lumora/use-api-key
# or
...
```ts
import { useApiKey } from 'lumora/use-api-key'
// or
import { useApiKey } from 'lumora/hooks'
```
...
import type { Props } from 'lumora/core'
import { useNext } from 'lumora/use-next'
import { useServices, useApiKey } from 'lumora/hooks'
